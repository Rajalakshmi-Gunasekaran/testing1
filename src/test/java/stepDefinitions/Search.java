...
public class Search extends BaseStep {
    ...
    public void i_should_see_all_the_header_tabs_in_journalist_profile_page() throws InterruptedException
    {
        ...
        wait(120);
        journoProfilePage.validateBioAndAlertsTab();
        wait(120);
        journoProfilePage.validateInterviewTab();
        wait(120);
        journoProfilePage.validateNotesAndActivity();
    }
    ...
    {
        wait(120);
        outletProfilePage.validateIAboutTabsINOutlet();
        wait(120);
        outletProfilePage.validateAlertsTabsINOutlet();
        wait(120);
        outletProfilePage.validateHeadlinesTabsINOutlet();
        wait(120);
        outletProfilePage.validateJournalistTabsINOutlet();
        wait(120);
        outletProfilePage.validateActivitiesTabsINOutlet();
        wait(120);
        outletProfilePage.validateTwitterTabINOutlet();
        wait(120);
    ...
    {
        wait(120);
        journoProfilePage.validateACLJournalist();
    }
