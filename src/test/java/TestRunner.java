...
@CucumberOptions(
        features = ".", dryRun = false,tags = "@CreateFolder,@CreateList,@AddingJournalistToTheList,@RemovingJournalistFromTheList,@GDPRDefaultStatus,@DeletingList,@DeletingFolder")
